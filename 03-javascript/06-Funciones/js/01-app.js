...
// Declaración de Función -> la expresión de la función utiliza la palabra reservada function seguida de un nombre y un parentesis, en este parentesis se colocan los argumentos, finalmente el cuerpo o predicado de la función se define por unas llaves...
...
sumar(); // se manda llamar por su nombre seguido del parentesis() y lo que está dentro, en caso de que exista (parámetros)
...
// Algunas veces mandarás a llamar una función que no tendrá los argumentos que se requieren, por ejemplo cuando llenas tu perfil de facebook tal vez no llenas todos los campos,   en esos casos son muy convenientes por parametros por default, veamos nuestra función si solo le pasamos el nombre pero no el apellido
